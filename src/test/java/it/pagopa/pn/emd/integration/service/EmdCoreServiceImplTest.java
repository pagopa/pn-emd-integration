...
class EmdCoreServiceImplTest {
    ...
    @Test
    void testGetPaymentUrlValidatesRetrievalIdThenDelegatesToPaymentService() {
        String retrievalId = "retrievalId";
        ...
        when(emdRetrievalService.getEmdRetrievalPayload(retrievalId)).thenReturn(Mono.just(payload));
    ...
    @Test
    void testGetPaymentUrlWithInvalidRetrievalIdReturnsNotFoundAndSkipsPaymentService() {
        String retrievalId = "retrievalId";
        String noticeCode = "noticeCode";
        String paTaxId = "paTaxId";
        Integer amount = 1000;
        ...
        when(emdRetrievalService.getEmdRetrievalPayload(retrievalId)).thenReturn(Mono.error(exception));
        ...
        verify(emdRetrievalService).getEmdRetrievalPayload(retrievalId);
        verify(emdPaymentService, never()).getPaymentUrl(any(), any(), any(), any());
    }
