...
public class PnEmdIntegrationExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String PN_EMD_INTEGRATION_INVALID_FORMAT = "PN_EMD_INTEGRATION_INVALID_FORMAT";
    public static final String PN_EMD_INTEGRATION_KEYCLOAK_TOKEN_ERROR = "PN_EMD_INTEGRATION_KEYCLOAK_TOKEN_ERROR";
}